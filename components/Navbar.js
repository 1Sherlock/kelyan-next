        ...
        <div className="Navbar ">
            ...
            <div className={isToggled ? "d-block" : "d-none"} id="sideBar">
                ...
                <div className="row d-none">
                        <div className="navbar">
                            <div className="d-flex align-items-center"><div className="navDots mt-4" /><Link href='/' ><a className={`nav-link`}>Главная</a></Link></div>
                            <div  className="d-flex align-items-center"><div className="navDots mt-4" /><Link href='/cases' ><a className={`nav-link`}>Кейсы</a></Link></div>
                            ...
                            <div className="dropdownFather   ">
                                ...
                                <div     id="drobdownMenuFather" className={isOpen ? "d-block" : "d-none"}>
                                    ...
                                    <div className="dropdownMenu">
                                        <div><div className="minus" /><Link href='/services' ><a>Услуги</a></Link></div>
                                        <div ><div className="minus" /><Link href='/smm' ><a>СММ</a></Link></div>
                                        <div ><div className="minus" /><Link href='/marceting' ><a>Реальный маркетинг</a></Link></div>
                                        <div ><div className="minus" /><Link href='/logo-page' ><a>Упаковка</a></Link></div>
                            ...
                            <div  className="d-flex align-items-center"><div className="navDots mt-2" /><Link href='/blog' className={`nav-link`}><a>Блог</a></Link></div>
                            <div  className="d-flex align-items-center"><div className="navDots mt-2" /><Link href='/about' className={`nav-link`}><a>О нас</a></Link></div>
                            <div  className="d-flex align-items-center"><div className="navDots mt-2" /><Link href='/' className="nav-link lang"><a>RU</a></Link></div>
                            <div  className="d-flex align-items-center"><div className="navDots mt-2" /><Link href='/' className="nav-link lang"><a>EN</a></Link></div>
                        </div>
